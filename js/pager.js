	...
	var ms = {
		...
		fillHtml:function(totalsubpageTmep,args){
			return (function(){
				...
				/************************START*********************/
				if(args.currPage > 1){
					totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='geraltTb_pager' data-go='' >上一页</a></li>";
				}
				...
				if(args.current < args.totalPage){
					totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='geraltTb_pager' data-go='' >下一页</a></li>";
				}else{
					totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='geraltTb_pager' data-go='' >下一页</a></li>";
				}
